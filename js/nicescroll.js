/* jquery.nicescroll 3.6.0 InuYaksa*2014 MIT http://nicescroll.areaaperta.com */ ;(function (
  f
) {
  ...
  var v = window.MutationObserver || window.WebKitMutationObserver || !1,
    ...
    R = function (k, c) {
      ...
      !e.cantouch ||
        ...
        ((this.istouchcapable = !0), (e.cantouch = !1))
      ...
      if (this.ishwscroll) {
        ...
        (this.getScrollTop = function () {
          ...
          (this.getScrollLeft = function () {
            return a.detected.ismozilla && a.isrtlmode
              ? Math.abs(a.docscroll.scrollLeft())
              : a.docscroll.scrollLeft()
          }),
          (this.setScrollLeft = function (b) {
            return a.docscroll.scrollLeft(
              a.detected.ismozilla && a.isrtlmode ? -b : b
            )
          })
      ...
      this.init = function () {
        ...
        e.hasmstouch &&
          a.css(a.ispage ? f('html') : a.win, { '-ms-touch-action': 'none' })
        a.zindex = 'auto'
        a.zindex =
          a.ispage || 'auto' != a.opt.zindex ? a.opt.zindex : m() || 'auto'
        ...
        if (!a.ispage || (!e.cantouch && !e.isieold && !e.isie9mobile)) {
          ...
          a.ispage &&
            ...
            ('BODY' == a.doc[0].nodeName
              ...
              : 'HTML' == a.doc[0].nodeName &&
                a.css(f('body'), { 'overflow-y': 'hidden' }))
          !e.isios ||
            a.ispage ||
            a.haswrapper ||
          ...
          for (J in k)
            (h = k[J]),
              (d = a.opt.railpadding[h])
                ? c.css('padding-' + h, d + 'px')
          ...
          a.ispage
            ? (c.css({ position: 'fixed', top: '0px', height: '100%' }),
              ...
              a.body.append(c),
              a.railh &&
                (l.css({ position: 'fixed', left: '0px', width: '100%' }),
                l.align ? l.css({ bottom: '0px' }) : l.css({ top: '0px' }),
                a.body.append(l)))
            : (a.ishwscroll
            ...
            (a.scrollmom = new L(a)),
              (a.onmangotouch = function () {
                ...
                var g = b - a.mangotouch.sy,
                  e = c - a.mangotouch.sx
                if (
                  0 != Math.round(Math.sqrt(Math.pow(e, 2) + Math.pow(g, 2)))
                ) {
                  var d = 0 > g ? -1 : 1,
                    f = 0 > e ? -1 : 1,
                    q = +new Date()
                  a.mangotouch.lazy && clearTimeout(a.mangotouch.lazy)
                  80 < q - a.mangotouch.tm ||
                  a.mangotouch.dry != d ||
                  a.mangotouch.drx != f
                    ? (a.scrollmom.stop(),
                ...
                if (2 == a.rail.drag.pt) {
                  ...
                  a.ishwscroll && a.opt.bouncescroll
                    ? 0 > k
                      ? (k = Math.round(k / 2))
                      : k > a.page.maxh &&
                        (k = a.page.maxh + Math.round((k - a.page.maxh) / 2))
                    : (0 > k && (q = k = 0),
                      k > a.page.maxh && ((k = a.page.maxh), (q = 0)))
                  var l
                  a.railh &&
                    a.railh.scrollable &&
                    ((l = a.isrtlmode
                    ...
                    a.ishwscroll && a.opt.bouncescroll
                      ...
                      : (0 > l && (h = l = 0),
                        l > a.page.maxw && ((l = a.page.maxw), (h = 0))))
                  g = !1
                  if (a.rail.drag.dl)
                    (g = !0),
                      'v' == a.rail.drag.dl
                        ? (l = a.rail.drag.sl)
                        : 'h' == a.rail.drag.dl && (k = a.rail.drag.st)
                  else {
                    d = Math.abs(d)
                    var u = Math.abs(u),
                  ...
                  a.synched('touchmove', function () {
                    a.rail.drag &&
                      ...
                      a.railh && a.railh.scrollable
                        ? (a.setScrollLeft(l), a.showCursor(k, l))
                        : a.showCursor(k),
        ...
        if ('IFRAME' == this.doc[0].nodeName) {
          var M = function () {
            ...
            if (!e.isios && a.opt.iframeautoresize && !a.isiframe) {
              ...
              a.doc.height('')
              var g = Math.max(
                b.getElementsByTagName('html')[0].scrollHeight,
                b.body.scrollHeight
              )
              a.doc.height(g)
            }
            ...
            e.isios &&
              a.haswrapper &&
              a.css(f(b.body), { '-webkit-transform': 'translate3d(0,0,0)' })
            'contentWindow' in this
              ? a.bind(this.contentWindow, 'scroll', a.onscroll)
              : a.bind(b, 'scroll', a.onscroll)
            a.opt.enablemousewheel && a.bind(b, 'mousewheel', a.onmousewheel)
            a.opt.enablekeyboard &&
              a.bind(b, e.isopera ? 'keypress' : 'keydown', a.onkeypress)
            if (e.cantouch || a.opt.touchbehavior)
              a.bind(b, 'mousedown', a.ontouchstart),
                ...
                a.opt.grabcursorenabled &&
                  e.cursorgrabvalue &&
                  a.css(f(b.body), { cursor: e.cursorgrabvalue })
            a.bind(b, 'mouseup', a.ontouchend)
            a.zoom &&
              (a.opt.dblclickzoom && a.bind(b, 'dblclick', a.doZoom),
          ...
          ? window.addEventListener || 'onwheel' in document
            ...
            : ((b =
                'undefined' != typeof document.onmousewheel
                  ...
                  : 'DOMMouseScroll'),
              n(h, b, d, f || !1),
              'DOMMouseScroll' == b && n(h, 'MozMousePixelScroll', d, f || !1))
          : h.addEventListener
          ? (e.cantouch &&
            ...
            (this.doScrollPos = function (b, c, d) {
              ...
              a.timer = setTimeout(function () {
                ...
                0 < h &&
                  ...
                  (a.timerscroll = {
                    bz: new A(d, a.newscrolly, h, 0, 0, 0.58, 1),
                    bh: new A(f, a.newscrollx, h, 0, 0, 0.58, 1),
                  }),
                  a.cursorfreezed ||
          ...
          : ((this.doScrollLeft = function (b, c) {
            ...
            (this.doScrollPos = function (b, c, d) {
              ...
              var l = 0,
                m = k
              0 == a.dst.x
                ? ((l = f), (m = c), (a.dst.ay = 1), (a.dst.py = 0))
                : 0 == a.dst.y &&
                  ((l = h), (m = b), (a.dst.ax = 1), (a.dst.px = 0))
              k = a.getTransitionSpeed(k)
              d && 1 >= d && (k *= d)
              a.bzscroll =
                0 < k
                  ? a.bzscroll
                    ? a.bzscroll.update(m, k)
                    : new A(l, m, k, 0, 1, 0, 1)
                  : !1
              if (!a.timer) {
                ;((f == a.page.maxh && c >= a.page.maxh) ||
                  (h == a.page.maxw && b >= a.page.maxw)) &&
                  a.checkContentSize()
                var n = 1
    ...
    L = function (f) {
      ...
      this.doSnapy = function (f, k) {
        ...
        0 > k
          ? ((k = 0), (d = !0))
          : k > c.nc.page.maxh && ((k = c.nc.page.maxh), (d = !0))
        0 > f
          ? ((f = 0), (d = !0))
          : f > c.nc.page.maxw && ((f = c.nc.page.maxw), (d = !0))
        d
          ? c.nc.doScrollPos(f, k, c.nc.opt.snapbackspeed)
        ...
        if ((c.speedy && d && c.speedy) || f) {
          ...
          var e = c.lastscrollx,
            ...
            t = function () {
              ...
              c.speedx &&
                ((e = Math.floor(c.lastscrollx - c.speedx * (1 - c.demulxy))),
                (c.lastscrollx = e),
                0 > e || e > a) &&
                (d = 0.1)
              c.speedy &&
                ((r = Math.floor(c.lastscrolly - c.speedy * (1 - c.demulxy))),
                (c.lastscrolly = r),
                0 > r || r > p) &&
                (d = 0.1)
              ...
              1 > c.demulxy
                ? (c.timer = setTimeout(t, s))
                : (c.stop(), c.nc.hideCursor(), c.doSnapy(e, r))
            }
          t()
  ...
  f.cssHooks.pageYOffset = {
    get: function (k, c, h) {
      return (c = f.data(k, '__nicescroll') || !1) && c.ishwscroll
        ? c.getScrollTop()
        : w.call(k)
    },
    set: function (k, c) {
  ...
  f.fn.getNiceScroll = function (k) {
    return 'undefined' == typeof k
      ? new C(this)
      : (this[k] && f.data(this[k], '__nicescroll')) || !1
  }
  f.extend(f.expr[':'], {
